...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        if scores.contains_key(&team_1_name){
            ...
            let entry = scores.entry(team_1_name).or_insert(Team{goals_scored: team_1_score,goals_conceded:team_2_score});
        ...
        if scores.contains_key(&team_2_name){
            ...
            let entry2 = scores.entry(team_2_name).or_insert(Team{goals_scored: team_2_score,goals_conceded:team_1_score});
        }
